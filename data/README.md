...
| `xtra/v3.0_raw_dataset_BASE.csv`       |  Aggregation of JSON files pertaining to the new prompt type "base". NB. Added after publication. |
| `xtra/v3.0_dataset_BASE.csv`           |  Same as above, but with emojis removed from Gemma output. NB. Added after publication. |
